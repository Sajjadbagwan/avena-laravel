...
class DeleteCategories extends Command
{
     ...
     * @var string
     */
    protected $signature = 'import:deleteAllMagentoCategories';
    ...
    {
        parent::__construct();
        $this->deleteCategoriesController = new DeleteCategoriesController;
    }
    ...
    {
        $this->deleteCategoriesController->deleteCategories();
        return 0;
    }
}
